...
beforeAfter:
  ...
  - before: { src: "/images/projects/old-field-app2.webp", alt: "Previous field app, second screen" }
    after: { src: "/images/projects/new-field-app2.webp", alt: "Redesigned field app, second screen" }
  - before: { src: "/images/projects/old-field-app3.webp", alt: "Previous field app, third screen" }
    after: { src: "/images/projects/new-field-app3.webp", alt: "Redesigned field app, third screen" }
order: 2
---
